...
niveau1 = shelve.open('score1.txt')
niveau1v1 = shelve.open('score1-1.txt')
niveau1v2 = shelve.open('score1-2.txt')
niveau2 = shelve.open('score2.txt')
niveau2v1 = shelve.open('score2-1.txt')
niveau2v2 = shelve.open('score2-2.txt')
niveau3 = shelve.open('score3.txt')
niveau3v1 = shelve.open('score3-1.txt')
niveau3v2 = shelve.open('score3-2.txt')
pygame.init()
surface = pygame.image.load("Snakeivo.png")
...
def jeu_debut():
    ...
    image_fond = pygame.image.load("SNAKE_pagecli.png")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN or event.key == pygame.K_SPACE:
                    if niveau == 1:
                        a=80
                        MainLoop("cases12.png",a,speed)
                    if niveau == 2:
                        a=50
                        MainLoop("cases13.png",a,speed)
                    if niveau == 3:
                        a=40
                        MainLoop("cases.png",a,speed)
...
def MainLoop(Image,tailleblock,Speed):
    ...
    while not game_over:
        ...
        if score == 0:
            pygame.draw.rect(dis, red, [pommex, pommey, snake_block, snake_block])
...
def prog_qui_gere_la_longueur_du_snake(snake_block, snake_list_parties):
    for x1 in snake_list_parties:
        pygame.draw.rect(dis, (0,255, 0), [x1[0], x1[1], snake_block, snake_block])
